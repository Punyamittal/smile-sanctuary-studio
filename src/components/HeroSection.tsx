  ...
  return (
    <section className="relative flex flex-col overflow-hidden pt-20">
      ...
      <motion.img
        src={dentalMirror}
        alt=""
        className="absolute top-32 right-[8%] w-20 md:w-28 opacity-[0.12] pointer-events-none hidden lg:block"
      ...
      <motion.img
        src={toothbrush}
        alt=""
        className="absolute bottom-[35%] left-[3%] w-16 md:w-24 opacity-[0.08] pointer-events-none hidden lg:block"
      ...
      <motion.img
        src={sparkleTooth}
        alt=""
        className="absolute top-[60%] right-[15%] w-12 md:w-16 opacity-[0.06] pointer-events-none hidden xl:block"
        style={{ x: mouse.x * 0.3, y: mouse.y * 0.3 }}
      ...
      <div className="container mx-auto px-4 flex-1 grid lg:grid-cols-[1fr_auto_1fr] gap-8 items-center relative z-10 py-12 md:py-16">
        <div className="space-y-6">
          ...
          >
            ...
            />
            <motion.span
              className="text-xs font-medium text-accent tracking-[0.15em] uppercase"
          ...
          {/* Title with word-by-word 3D reveal */}
          ...
          {/* Info card with stagger */}
          <motion.div
            initial={{ opacity: 0, y: 30, scale: 0.95 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ duration: 0.7, delay: 0.8, ease: [0.22, 1, 0.36, 1] as [number, number, number, number] }}
            className="bg-card/80 backdrop-blur-md rounded-2xl p-5 max-w-sm shadow-lg border border-border/50"
          >
          ...
          >
            <Button asChild variant="accent" size="lg" className="rounded-full px-8 group shadow-lg shadow-accent/20">
              <Link to="/contact">
                Book Appointment
        ...
        >
          ...
          <motion.img
            ...
            className="w-[280px] md:w-[380px] lg:w-[420px] xl:w-[480px] drop-shadow-2xl relative z-10"
      ...
      <div className="relative z-10 bg-primary mt-8 overflow-hidden">
        ...
        <motion.img
          src={toothbrush}
          alt=""
          className="absolute -top-6 -right-4 w-32 md:w-44 opacity-[0.08] pointer-events-none rotate-45"
          animate={{ y: [0, -8, 0] }}
        ...
        <motion.img
          src={floatingTooth}
          alt=""
          className="absolute bottom-4 left-[5%] w-20 opacity-[0.06] pointer-events-none"
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-center">
            <div>
              ...
              >
                ...
                >
                  <Button asChild variant="accent" size="lg" className="rounded-full px-8 mt-6 group shadow-lg shadow-accent/25">
                    <Link to="/services">
                      Explore Services
                      <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
